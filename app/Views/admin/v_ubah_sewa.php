<div class="col-md-12">
  <div class="card">
    <div class="card-header">
      <h5 class="card-title"><b><?= $title; ?></b> | <a href="<?= base_url('Admin/Tambahpesan'); ?>" class="btn btn-primary btn-sm ml-auto"><i class="fa fa-plus"></i> Add</a></h5>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <!-- notifikasi-->
          ...
          foreach ($sewa as $key => $value) { ?>
            <tr>
              ...
              <td class="text-center">
                <a href="<?= base_url('Admin/Ubahpesan/' . $value['id_sewa']); ?>" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-edit"></i> Ubah</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php echo form_open(base_url('Admin/Deletepesan/' . $value['id_sewa'])) ?>
