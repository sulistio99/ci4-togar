...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jun 2023 pada 19.56
...
INSERT INTO `tb_hunian` (`id_hunian`, `id_member`, `nama_hunian`, `nama_pemilik`, `id_kategori`, `deskripsi_hunian`, `status_hunian`, `harga_hunian`, `alamat_hunian`, `info`, `luas_tanah`, `luas_bangunan`, `id_provinsi`, `id_kabupaten`, `id_kecamatan`, `gambar`) VALUES
(14, 15, 'Kontrakan coklat A01', 'Eko', 2, '2 Kamar tidur, 1 dapur, 1 kamar mandi, 1 ruang tamu, tempat parkiran', 'kosong', 1000000, 'Jl. Keadilan Bau 2', 'Jalan Pas Pinggir Jalan Raya, Strategis dekat warung makan dll.', 20, 25, 63, 7310, 1805070, 'hunian1.jpg'),
(16, 14, 'Kontrakan coklat A02', 'Togar', 1, '2 Kamar tidur, 1 dapur, 1 kamar mandi, 1 ruang tamu, tempat parkiran, ', 'Sold out', 1000000, 'Jl. Keadilan Bau 1', 'Dekat Masjid', 45, 30, 0, 0, 0, 'hunian2.jpg'),
(17, 14, 'Kontrakan abu-abu B01', 'Togar', 1, '2 Kamar tidur lengkap dengan kasur, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Sold Out', 1250000, 'Jl. Keadilan Bau 3', 'Dekat Warung Makan Sate Iga', 0, 0, 0, 0, 0, 'hunian3.jpg'),
(18, 15, 'Kontrakan abu-abu B02', 'Eko', 2, '2 Kamar tidur  + AC, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'kosong', 1500000, 'Kesehatan Makmur No.9', 'Halaman Depan Ada Pos', 68, 84, 17, 1172, 1101031, 'hunian4.jpg'),
(19, 14, 'Kontrakan abu-abu C01', 'Togar', 1, '2 Kamar tidur, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Sold Out', 1300000, 'Jl. Keadilan Bau 4', 'Tempat Parkiran Luas', 0, 0, 0, 0, 0, 'hunian2.jpg'),
(20, 16, 'Kontrakan abu-abu C02', 'Hj.Aceng', 2, '2 Kamar tidur + AC, 1 dapur, 1 kamar mandi, 1 ruang tamu', 'Available', 1500000, 'Jl. Makmur Sejahtera No.1', 'Lahan Depan Luas', 108, 39, 0, 0, 0, 'hunian3.jpg'),
(22, 14, 'Kos Pria Enteran', 'Togar', 1, 'Kamar Mandi Dalam, Kamar, AC', 'Available', 550000, 'Jalan Keadilan No.9 KM.2', 'Lokasi Aman', 80, 182, 0, 0, 0, '1684604155_7e4fa00bd8df5fb09633.jpg'),
(23, 14, 'Kos Wanita Enteran', 'Togar', 1, 'WC Dalam, Ac, Dapur', 'Available', 750000, 'Jalan Daya No.2 KM.7', 'Lokasi Aman Dan Strategis', 36, 30, 0, 0, 0, '1684604235_2916b7a21a32007f3a00.jpg'),
(24, 12, 'KOS Pria Elegan Luas', 'Abur Malik Anwar', 1, 'WC Dalam, Dapur, Parkiran, AC', 'Available', 670000, 'Jl. Bau bau selatan KM.4', 'Lahan Parkiran Luas Samping Kos', 38, 30, 0, 0, 0, '1684651141_4cbe653ef9a62806c996.jpg'),
(25, 12, 'KOS Pria Elegan Luas', 'Abur Malik Anwar', 1, 'WC Dalam, Ac, Dapur', 'Available', 750000, 'Jl. Bau bau utara KM.4', 'Parkiran Luas Area Kos', 0, 0, 0, 0, 0, '1684651205_f346c7ec476130f9be7b.jpg'),
(26, 11, 'Kontrakan Elit Luas', 'Agung Ginanjar', 2, 'Kamar 2, Wc Dalam, Dapur, Pos', 'Available', 3500000, 'Jl. Sosial Adil No.11, KM.2', 'Area Parkir Luas dan ada pos ronda', 40, 30, 0, 0, 0, '1684651307_3344f74c3281fc275721.jpg'),
(27, 11, 'Kos Pria Ramah Jaya', 'Togar', 1, 'WC Dalam, Dapur', 'Available', 550000, 'Jl. Keadilan Bau 2', 'Parkiran Luas', 36, 39, 0, 0, 0, '1684651391_cda59eacdce00b2426ba.jpg'),
(32, 11, 'Anwar Mart', 'Hj. Anwar Salim', 1, '', 'kosong', 450000, 'Jl. Buton 12', '', 30, 35, 0, 0, 0, '1685665240_50be8bb0c95f9a9216bd.jpg');
...
(17, 'akba', '123', 'akba@gmail.com', 'pengusaha', '082194330041', 'jalan baru 1');
...
(24, 17, 17, '2023-06-06', '12 Bulan', 'Proses');
...
(7, 24, 17, 17, '2023-06-05', '1243', '1685947961_d74df93116ac6e2c7e07.jpg', 'BELUM LUNAS', 'Jun 2023');
...
--
ALTER TABLE `tb_member`
  MODIFY `id_member` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `tb_pesan`
--
ALTER TABLE `tb_pesan`
  MODIFY `id_pesan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT untuk tabel `tb_sewa`
--
ALTER TABLE `tb_sewa`
  MODIFY `id_sewa` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
